...
train <- read.csv("D:/pml-training.csv", na.strings="NA")
submittest<-read.csv("D:/pml-testing.csv", na.strings="NA")
```
...
```{r,echo=TRUE,results='hide'}
train <- read.csv("D:/pml-training.csv", na.strings=c("NA","#DIV/0!",""))
submittest <- read.csv("D:/pml-testing.csv", na.strings=c("NA","#DIV/0!",""))
```
